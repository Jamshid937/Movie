const API_KEY = `3904f51d23e1cbf409206b61b67129ae`
...
const trending_el = document.querySelector('.tranding .movies-grid')

const popup_container = document.querySelector('.popup-container')

function add_click_efect_to_card (cards) {
cards.forEach(card => {
...
<div class="content">
 ...
 <div class="right">
     ...
     <div class="trailer">
         <h2>Trailer</h2>
         <iframe width="560" height="315" src="https://www.youtube.com/embed/${movie_trailer}" title="Ambient Light Effects | CSS 3D Glowing Cube Animation Effects" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     </div>
 </div>
</div>
...
get_tranding_movies()
async function get_tranding_movies (){
...
const data = await get_tranding_movies()
